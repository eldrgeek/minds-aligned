/* Minimal guide config for alex-wissner-gross — created by build-hosts.mjs because none existed.
 * Safe to replace with a hand-authored siteMap + walkthroughs; the host layer in
 * alex-wissner-gross-host.js merges over whatever is here. */
window.SomaGuideConfig = {
  siteMap: [
    { label: 'Home',       path: '/',            description: 'Overview of the archive of Alex Wissner-Gross's published work.' },
