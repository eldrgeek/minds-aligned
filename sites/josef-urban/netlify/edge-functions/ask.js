...
function systemFrame(hostName) {
  return [
    ...
    '',
    'A passage whose source line reads "archive reading" is THIS ARCHIVE\'S OWN synthesis across',
    `the work — it is not something ${CORPUS.person} wrote or said. When you draw on one, attribute it`,
    'that way ("the archive reads this as…", "across these papers the archive sees…") and name the',
    'papers it rests on so the reader can check it. Never present an archive reading as the subject\'s',
    'claim, quotation, or stated position.',
    '',
