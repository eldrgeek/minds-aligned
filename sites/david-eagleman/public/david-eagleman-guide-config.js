/* David Eagleman per-site config for the SOMA Guide widget.
 * Persona: Eagleman Guide — an AI guide grounded in David Eagleman's public corpus.
...
window.SomaGuideConfig = {
  persona: {
    ...
    avatar:  '⚡',
    greeting:
      "I'm an AI guide grounded in David Eagleman's published work — the neuroscience of perception, time, sensory substitution, and brain plasticity. I'm not David Eagleman myself, but I can help you navigate the corpus and the ideas this research introduced.",
      ...
      steps: [
        {
          ...
          target:      'nav a[href="/"]',
          narration:
            "Welcome to the David Eagleman archive — a searchable index of published papers, " +
