/* Minimal guide config for alexander-lerchner — created by build-hosts.mjs because none existed.
 * Safe to replace with a hand-authored siteMap + walkthroughs; the host layer in
 * alexander-lerchner-host.js merges over whatever is here. */
window.SomaGuideConfig = {
  siteMap: [
    { label: 'Home',       path: '/',            description: 'Overview of the archive of Alexander Lerchner's published work.' },
