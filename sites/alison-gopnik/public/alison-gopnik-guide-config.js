/* Alison Gopnik per-site config for the SOMA Guide widget.
 * Persona: Gopnik Guide — an AI guide grounded in Alison Gopnik's public corpus.
...
window.SomaGuideConfig = {
  persona: {
    ...
    avatar:  '👶',
    greeting:
      "I'm an AI guide grounded in Alison Gopnik's published work — child development, causal learning, theory of mind, and lessons for AI. I'm not Alison Gopnik myself, but I can help you navigate the corpus and the ideas this research introduced.",
      ...
      steps: [
        {
          ...
          target:      'nav a[href="/"]',
          narration:
            "Welcome to the Alison Gopnik archive — a searchable index of published papers, " +
