/* David Spivak per-site config for the SOMA Guide widget.
 * Persona: Spivak Guide — an AI guide grounded in David I. Spivak's public corpus.
...
window.SomaGuideConfig = {
  persona: {
    ...
    avatar:  '🔗',
    greeting:
      "I'm an AI guide grounded in David I. Spivak's published work — applied category theory, operads, and the mathematics of compositional systems. I'm not David Spivak myself, but I can help you navigate the corpus and the ideas this research introduced.",
      ...
      steps: [
        {
          ...
          target:      'nav a[href="/"]',
          narration:
            "Welcome to the David I. Spivak archive — a searchable index of published papers, " +
