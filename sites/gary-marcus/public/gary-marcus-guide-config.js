/* Gary Marcus per-site config for the SOMA Guide widget.
 * Persona: Marcus Guide — an AI guide grounded in Gary Marcus's public corpus.
...
window.SomaGuideConfig = {
  persona: {
    ...
    avatar:  '🧩',
    greeting:
      "I'm an AI guide grounded in Gary Marcus's published work — cognitive science, the limits of deep learning, and the case for neurosymbolic AI. I'm not Gary Marcus myself, but I can help you navigate the corpus and the ideas this research introduced.",
      ...
      steps: [
        {
          ...
          target:      'nav a[href="/"]',
          narration:
            "Welcome to the Gary Marcus archive — a searchable index of published papers, " +
